...
<body>
    ...
    <script>
        ...
        function next(){
            ...
            if($("#reg_type").val() == '' || $("#email_address").val() == '' || $("#title").val() == '' || $("#firstname").val() == '' || $("#lastname").val() == ''){
                ...
                alert("correct");
                $("#step-1").addClass('d-none').animate().hide('slow');
                $("#step-2").removeClass('d-none').animate().show('fast');
        ...
        function next1(){
            ...
            if($("#address1").val() == '' || $("#country").val() == '' || $("#city").val() == '' || $("#zip").val() == '' || $("#phone_no").val() == '' || $("#aid").val() == ''){

                alert("All fields are required");
            }else{
                alert("correct");
                $("#step-2").addClass('d-none').animate().hide('slow');
                $("#step-3").removeClass('d-none').animate().show('fast');
                $("#selfservice_stage_progressbar").css('width', '50%');
            }
        }
        ...
        //                 // toolbarExtraButtons: [$("<button class=\"btn btn-primary\" onclick=\"payWithPaystack(event)\">Make Payment</button>")]
        //             }
        //         })
        ...
        // function sponsor() {
        //     var inputamount = '<div class="form-group"><label class=\"form-label"\>Amount <span class=\"text-danger"\>*</span> </label><input name="amount" id="amount" type="number" value="100000" class="form-control" readonly></div>';
        //     $("#sponsor-amount").html(inputamount);
        // }
        // $("#payWithPaystack").on("click", function() {
        //         alert('yeah')
        //     });
