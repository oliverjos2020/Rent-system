                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="name" placeholder="Name" value="{{$role->name}}" name="name">
                                    @error('name')
                            ...
                            <div class="col-md-8">
                                ...
                                <table id="datatables-basic" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$role->id}}</td>
                                            <td><a href="{{route('dashboard.editrole', $role->id)}}">{{$role->name}}</a></td>
                                            <td>
